...
<div class="card ">
  ...
  <div class="card-body pr-2 pl-2">
    <table id="datatableid" class="display" style="width:80%">
      <thead>
        <tr>
  ...
  <tbody>
    <?php
       $allUser = $users->selectAllUserData5();
       if ($allUser) {
        $i = 0;
    ...
    <td><?php if($value->MajID == '2'){
      echo "IT";
    }else echo "None"; ?></span></td>
    <td><?php if($value->ClassID == '1'){
      echo "Freshman";
    }elseif($value->ClassID == '2'){
      echo "Sophmore";
    }elseif($value->ClassID == '3'){
      echo "Junior";
    }else echo"Senior"; ?></span></td>
    <td><span class="badge badge-lg badge-secondary text-white"><?php echo ($value->RoleID);  ?></span></td>
                    ...
                    <?php if ( $value->StudID) {
                      echo "disabled";
                             ...
                             btn-sm " href="?remove=<?php echo $value->StudID;?>">Remove</a>
                       ...
                       <?php if ($value->StudID) {
                         echo "disabled";
                                ...
                                btn-sm " href="?active=<?php echo $value->FacID;?>">Active</a>
                             <?php } ?>
                        ...
                        <?php  }elseif($value->StudID  && Session::get("roleid") == '3'){ ?>
                          <a class="btn btn-success btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">View</a>
                          <a class="btn btn-info btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">Edit</a>
                        <?php  }elseif( Session::get("roleid") == '3'){ ?>
                          <a class="btn btn-success btn-sm
                          <?php if ($value->RoleID == '1') {
                            echo "disabled";
                          } ?>
                          " href="profile.php?id=<?php echo $value->StudID;?>">View</a>
                          <a class="btn btn-info btn-sm
                          <?php if ($value->RoleID == '1') {
                            echo "disabled";
                          } ?>
                          " href="profile.php?id=<?php echo $value->StudID;?>">Edit</a>
                        <?php }elseif(Session::get("id") == $value->StudID  && Session::get("roleid") == '3'){ ?>
                          <a class="btn btn-success btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">View</a>
                          <a class="btn btn-info btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">Edit</a>
                        <?php }else{ ?>
                          <a class="btn btn-success btn-sm
