  ...
  <td><span class="badge badge-lg badge-secondary text-white"><?php echo ($value->RoleID);  ?></span></td>
                        ...
                        <td>
                          <?php if ( Session::get("roleid") == '5') {?>
                            ...
                            <a class="btn btn-info btn-sm " href="../AdminUsers/EnrollStudent.php?id=<?php echo $value->StudID;?>">ENROLL</a>
<a class="btn btn-info btn-sm " href="../StudentUsers/Sched2.php?id=<?php echo $value->StudID;?>">Schedule</a>
                    ...
                    <?php if ( $value->StudID) {
                      echo "disabled";
                             ...
                             <?php if ($value->isActive == '0') {  ?>
                               <a onclick="return confirm('Are you sure you would like To Deactivate User ?')" class="btn btn-warning
                       <?php if ($value->StudID) {
                         echo "disabled";
                       } ?>
...
<a class="btn btn-info btn-sm " href="../StudentUsers/Sched2.php?id=<?php echo $value->StudID;?>">Schedule</a>
                        ...
                        <?php }elseif( $value->StudID  && Session::get("roleid") == '4'){ ?>
                          <a class="btn btn-success btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">View</a>
                          <a class="btn btn-info btn-sm " href="../AdminUsers/EnrollStudent.php?id=<?php echo $value->StudID;?>">ENROLL</a>
<a class="btn btn-info btn-sm " href="../StudentUsers/Sched2.php?id=<?php echo $value->StudID;?>">Schedule</a>
<?php }elseif($value->StudID  && Session::get("roleid") == '2'){ ?>
  <a class="btn btn-success btn-sm " href="profile.php?id=<?php echo $value->StudID;?>">View</a>
  <a class="btn btn-info btn-sm " href="../AdminUsers/EnrollStudent.php?id=<?php echo $value->StudID;?>">ENROLL</a>
<a class="btn btn-info btn-sm " href="../StudentUsers/Sched2.php?id=<?php echo $value->StudID;?>">Schedule</a>
                        <?php }else{ ?>
