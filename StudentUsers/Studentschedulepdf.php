...
$pdf->Cell(20,5,'Semester',1,0,'C',1);
$pdf->Cell(10,5,' Year',1,0,'C',1);
$pdf->Cell(10,5,'Start',1,0,'C',1);
$pdf->Cell(10,5,'End',1,0,'C',1);
$pdf->Cell(20,5,'Time',1,0,'C',1);
$pdf->Cell(20,5,'Location',1,0,'C',1);
$pdf->Cell(20,5,'Course',1,0,'C',1);
$pdf->Cell(10,5,' Credits',1,0,'C',1);
...
while ($ScheduleData=mysqli_fetch_array($query)) {
  // code... $Semester = $value-> SemSemester;
        ...
        $pdf->Cell(20,4,$Semester,0,0,'C');
        $pdf->Cell(10,4,$Year,0,0,'C');
        $pdf->Cell(10,4,$Start,0,0,'C');
        $pdf->Cell(10,4,$End,0,0,'C');
        $pdf->Cell(20,4,$Time,0,0,'C');
        $pdf->Cell(20,4,$Location,0,0,'C');
        $pdf->Cell(20,4,$Course,0,0,'C');
        $pdf->Cell(10,4,$Credits,0,0,'C');
