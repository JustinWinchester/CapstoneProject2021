...
if (isset($activeId)) {
 ...
 ?>
	...
	<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
          <h3><i class="fas fa-users mr-2"></i>C U ENROLL ME <span class="float-right"> Welcome! <strong>
...
<ul>
<li><a  href="../AdminUsers/addStudentUser.php" onclick=" window.open('../AdminUsers/addStudentUser.php','twelve','height=300,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;">Add Student User!FIXED</a></li>
...
<li><a  href="../AllUsers/SecForm2.php"  onclick=" window.open('../AllUsers/SecForm2.php','thrtn','height=300,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;">Assign Student Advisor</a></li>
<li><a href="CourseCatalog.php"  onclick=" window.open('CourseCatalog.php','frtn','height=300,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;">View Course Information</a></li>
<li><a href="../AdminUsers/AddNewSectionAdmin.php"  onclick=" window.open('../AdminUsers/AddNewSectionAdmin.php','sxtn','height=300,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;">Add Faculty User</a></li>
<li><a href="../AdminUsers/AddCourseAdmin.php"  onclick=" window.open('../AdminUsers/AddCourseAdmin.php','sevtn','height=300,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;">Add Faculty User</a></li>
...
<div class="col-3 col-s-3 menu">
<ul>
<li><a href="pdftest.php" onclick=" window.open('pdftest.php','three','height=300,width=400,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'); return false;"><i class="fa fa-fw fa-user"></i> Print Schedule</a></li>
...
<br>
<p>All Information Presented in this Project Website about nature was obtained through the open source information source WikiPedia <br>
	And more information and the source of this webite nature info can be found through the reference link in the navigation bar at the top Nature Wikis!<br>
3 of the Images and the website template for this design project are referenced to the source W3schools.com
<a href="https://www.w3schools.com">W3schools</a><br>
The other image was obtained through google images found in the Navigation link  as Google Search!</p>
